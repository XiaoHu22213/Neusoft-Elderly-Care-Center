	...
	<div style="margin-left: 20px; margin-right: 30px;">
		<el-form ref="formObj" :model="service" label-width="80px">
			...
			<el-form-item>
				...
				<el-button type="primary" plain :icon="Save" @click="xianshi()">显示</el-button>
			</el-form-item>
...
function save() {
	post(url.update, service, content => {
		emits('update:show', false)
		emits('getTableData')
	}, formObj)
}
function getById () {
	get('/servicetargets/getById', { id: props.id }, content => {
		console.dir(content)
